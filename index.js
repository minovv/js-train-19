...
// ScienceBook.info = "Це наукова книга";
...
// Тому створимо гетер який буде нам повертати рядок: Про книгу <title>: <info>
Object.defineProperty(ScienceBook, "info", {
	set(value) {
		this._info = value;
	},
	get() {
		console.log(`Про книгу ${this.title}: ${this._info}`);
	},
});
...
ScienceBook.info = "написана в 1915 році";	// Викликаємо сетер
ScienceBook.pages = 200;
